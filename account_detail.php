<?php
/**
  * File contains detail page of image when clicked from account
  * Page opens when picture is clicked from only from account. Shows image with no watermark after purchased by user.
  *
  * @author Albert Yu
  *
  * 
